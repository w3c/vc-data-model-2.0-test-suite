      ...
      it('A verifiable credential MUST contain a credentialSubject property.',
        async function() {
          ...
          await assert.rejects(endpoints.issue(require(
            '../tests/input/credential-no-subject-fail.json')),
