...
describe('5.00 Advanced Concepts', function() {
  ...
  for(const [name, implementation] of match) {
    ...
    describe(name, function() {
      ...
      it(trimText(`JSON-LD-based processors MUST produce an error when a
      ...
      async function() {
        ...
        {name: 'HTTPError'},
        trimText(`Failed to reject a VC which redefines the 
      ...
      it(trimText(`The value of the relatedResource property MUST be one or more
      ...
      it(trimText(`The identifier for the resource is REQUIRED and 
        conforms to the format defined in Section 4.4 Identifiers. 
      ...
      it(trimText(`Each object associated with relatedResource MUST contain 
        at least a digestSRI or a digestMultibase value.`),
      async function() {
      ...
      it(trimText(`The value of the refreshService property MUST be one or more
      ...
      it(trimText(`Each refreshService value MUST specify its type.`),
        async function() {
      ...
      it(trimText(`The value of the termsOfUse property MUST specify one or
      ...
      it(trimText(`Each termsOfUse value MUST specify its type, for example,
      ...
      it(trimText(`If present, the value associated with the 
        evidence property is a single object or a set of one or more objects.`),
      async function() {
      ...
      it(trimText(`In order to avoid collisions regarding how the following
