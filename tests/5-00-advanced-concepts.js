  ...
  for(const [name, implementation] of match) {
    ...
    describe(name, function() {
      ...
      it('JSON-LD-based processors MUST produce an error when a \
        ...
        {name: 'HTTPError'},
        'Failed to reject a VC which redefines the \
      ...
      it('The identifier for the resource is REQUIRED and \
      ...
      it('Each object associated with relatedResource MUST contain \
      ...
      it('If present, the value associated with the \
