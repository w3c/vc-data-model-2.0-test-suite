...
import {addPerTestMetadata, setupMatrix, spaces}
  from './helpers.js';
...
describe('4.05 Types', function() {
  ...
  for(const [name, implementation] of match) {
    ...
    describe(name, function() {
      ...
      it('The value of the type property MUST be one or more terms \
        ...
        'Failed to accept a VC with an additional type \
      ...
      it('If more than one (type) value is provided, the order does not \
        matter.'.replace(spaces, ' '), async function() {
        ...
        'Failed to accept a VC with different type \
      ...
      it('Verifiable Credential objects MUST have a type \
      ...
      it('Verifiable Presentation objects MUST have a \
